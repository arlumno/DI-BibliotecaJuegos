...
"")
        ...
        self.lbCod = QtWidgets.QLabel(self.horizontalLayoutWidget_4)
        self.lbCod.setAlignment(QtCore.Qt.AlignLeading|QtCore.Qt.AlignLeft|QtCore.Qt.AlignVCenter)
        self.lbCod.setObjectName("lbCod")
        self.horizontalLayout_4.addWidget(self.lbCod)
        self.etCod = QtWidgets.QLineEdit(self.horizontalLayoutWidget_4)
        self.etCod.setMaximumSize(QtCore.QSize(40, 16777215))
        self.etCod.setReadOnly(True)
        self.etCod.setObjectName("etCod")
        self.horizontalLayout_4.addWidget(self.etCod)
    ...
    def retranslateUi(self, DialogAddJuego):
        ...
        DialogAddJuego.setWindowTitle(_translate("DialogAddJuego", "Añadir/Editar Juego"))
        ...
        self.lbCod.setText(_translate("DialogAddJuego", "Cod:"))
