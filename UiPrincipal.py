...
"*/")
        ...
        self.tableWidget = QtWidgets.QTableWidget(self.listado)
        self.tableWidget.setGeometry(QtCore.QRect(20, 120, 841, 421))
        ...
        self.groupBox.setGeometry(QtCore.QRect(20, 49, 841, 61))
        self.groupBox.setObjectName("groupBox")
        self.bResetFilters = QtWidgets.QPushButton(self.groupBox)
        self.bResetFilters.setGeometry(QtCore.QRect(700, 30, 101, 23))
        self.bResetFilters.setObjectName("bResetFilters")
        self.etNombre = QtWidgets.QLineEdit(self.groupBox)
        self.etNombre.setGeometry(QtCore.QRect(40, 30, 141, 20))
        palette = QtGui.QPalette()
        self.etNombre.setPalette(palette)
        self.etNombre.setObjectName("etNombre")
        self.label = QtWidgets.QLabel(self.groupBox)
        self.label.setGeometry(QtCore.QRect(40, 7, 141, 21))
        self.label.setAlignment(QtCore.Qt.AlignCenter)
        self.label.setObjectName("label")
        self.cbGenero = QtWidgets.QComboBox(self.groupBox)
        self.cbGenero.setGeometry(QtCore.QRect(210, 30, 81, 22))
        self.cbGenero.setObjectName("cbGenero")
        self.cbDificultad = QtWidgets.QComboBox(self.groupBox)
        self.cbDificultad.setGeometry(QtCore.QRect(310, 30, 69, 22))
        self.cbDificultad.setObjectName("cbDificultad")
        self.label_3 = QtWidgets.QLabel(self.groupBox)
        self.label_3.setGeometry(QtCore.QRect(210, 7, 81, 21))
        self.label_3.setAlignment(QtCore.Qt.AlignCenter)
        self.label_3.setObjectName("label_3")
        self.label_4 = QtWidgets.QLabel(self.groupBox)
        self.label_4.setGeometry(QtCore.QRect(310, 7, 71, 21))
        self.label_4.setAlignment(QtCore.Qt.AlignCenter)
        self.label_4.setObjectName("label_4")
        self.cbMinJugadores = QtWidgets.QComboBox(self.groupBox)
        self.cbMinJugadores.setGeometry(QtCore.QRect(430, 30, 35, 22))
        self.cbMinJugadores.setObjectName("cbMinJugadores")
        self.label_5 = QtWidgets.QLabel(self.groupBox)
        self.label_5.setGeometry(QtCore.QRect(420, 7, 121, 21))
        self.label_5.setAlignment(QtCore.Qt.AlignCenter)
        self.label_5.setObjectName("label_5")
        self.label_6 = QtWidgets.QLabel(self.groupBox)
        self.label_6.setGeometry(QtCore.QRect(470, 30, 31, 21))
        self.label_6.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_6.setObjectName("label_6")
        self.cbMaxJugadores = QtWidgets.QComboBox(self.groupBox)
        self.cbMaxJugadores.setGeometry(QtCore.QRect(502, 30, 35, 22))
        self.cbMaxJugadores.setObjectName("cbMaxJugadores")
        self.label_7 = QtWidgets.QLabel(self.groupBox)
        self.label_7.setGeometry(QtCore.QRect(397, 30, 31, 21))
        self.label_7.setAlignment(QtCore.Qt.AlignRight|QtCore.Qt.AlignTrailing|QtCore.Qt.AlignVCenter)
        self.label_7.setObjectName("label_7")
        self.cbPropietario = QtWidgets.QComboBox(self.groupBox)
        self.cbPropietario.setGeometry(QtCore.QRect(570, 30, 111, 22))
        self.cbPropietario.setObjectName("cbPropietario")
        self.label_10 = QtWidgets.QLabel(self.groupBox)
        self.label_10.setGeometry(QtCore.QRect(570, 10, 111, 21))
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bResetFilters.setText(_translate("MainWindow", "Reiniciar Filtros"))
