...
"*/")
        ...
        self.bAddJuego = QtWidgets.QPushButton(self.add)
        self.bAddJuego.setGeometry(QtCore.QRect(40, 30, 131, 41))
        self.bAddJuego.setObjectName("bAddJuego")
        self.bAddGame_2 = QtWidgets.QPushButton(self.add)
        self.bAddGame_2.setGeometry(QtCore.QRect(670, 180, 121, 41))
        self.bAddGame_2.setObjectName("bAddGame_2")
        self.lwPropietarios = QtWidgets.QListWidget(self.add)
        self.lwPropietarios.setGeometry(QtCore.QRect(670, 230, 121, 192))
        self.lwPropietarios.setObjectName("lwPropietarios")
        item = QtWidgets.QListWidgetItem()
        self.lwPropietarios.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.lwPropietarios.addItem(item)
        item = QtWidgets.QListWidgetItem()
        self.lwPropietarios.addItem(item)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.bAddJuego.setText(_translate("MainWindow", "Añadir Nuevo Juego"))
        self.bAddGame_2.setText(_translate("MainWindow", "Añadir Propietarios"))
        __sortingEnabled = self.lwPropietarios.isSortingEnabled()
        self.lwPropietarios.setSortingEnabled(False)
        item = self.lwPropietarios.item(0)
        item.setText(_translate("MainWindow", "asd"))
        item = self.lwPropietarios.item(1)
        item.setText(_translate("MainWindow", "asdabvfd"))
        item = self.lwPropietarios.item(2)
        item.setText(_translate("MainWindow", "6ijg"))
        self.lwPropietarios.setSortingEnabled(__sortingEnabled)
