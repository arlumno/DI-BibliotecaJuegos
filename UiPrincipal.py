...
"")
        ...
        self.twListadoJuegos.setSizeAdjustPolicy(QtWidgets.QAbstractScrollArea.AdjustToContents)
        ...
        item.setFont(font)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/recursos/logo_dados.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        item.setIcon(icon)
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 17, 641, 45))
        ...
        self.cbMinJugadores.setMinimumSize(QtCore.QSize(40, 0))
        ...
        self.cbMaxJugadores.setMinimumSize(QtCore.QSize(40, 0))
        ...
        self.bReiniciarFiltros.setGeometry(QtCore.QRect(744, 22, 91, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.bReiniciarFiltros.setFont(font)
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/recursos/eliminar_filtros.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bReiniciarFiltros.setIcon(icon1)
        self.bReiniciarFiltros.setIconSize(QtCore.QSize(30, 30))
        self.bReiniciarFiltros.setObjectName("bReiniciarFiltros")
        self.bFiltrar = QtWidgets.QPushButton(self.groupBox)
        self.bFiltrar.setGeometry(QtCore.QRect(657, 22, 81, 41))
        font = QtGui.QFont()
        font.setBold(True)
        font.setWeight(75)
        self.bFiltrar.setFont(font)
        icon2 = QtGui.QIcon()
        icon2.addPixmap(QtGui.QPixmap(":/icons/recursos/filtrar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bFiltrar.setIcon(icon2)
        self.bFiltrar.setIconSize(QtCore.QSize(30, 30))
        ...
        self.groupBox_2.setGeometry(QtCore.QRect(680, 70, 171, 251))
        self.groupBox_2.setObjectName("groupBox_2")
        self.bImportarBD = QtWidgets.QPushButton(self.groupBox_2)
        self.bImportarBD.setGeometry(QtCore.QRect(10, 120, 149, 50))
        self.bImportarBD.setStyleSheet("background-color: qlineargradient(spread:pad, x1:1, y1:0, x2:0, y2:1, stop:0 rgba(255, 100,100, 255), stop:1 rgba(255, 255, 255, 255));")
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/icons/recursos/Misc_Upload_Database_Icon_256.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bImportarBD.setIcon(icon3)
        self.bImportarBD.setIconSize(QtCore.QSize(40, 40))
        self.bImportarBD.setObjectName("bImportarBD")
        self.bExportarBD = QtWidgets.QPushButton(self.groupBox_2)
        self.bExportarBD.setGeometry(QtCore.QRect(10, 30, 149, 51))
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/icons/recursos/Download Database.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bExportarBD.setIcon(icon4)
        self.bExportarBD.setIconSize(QtCore.QSize(40, 40))
        self.bExportarBD.setObjectName("bExportarBD")
        self.bEliminarBD = QtWidgets.QPushButton(self.groupBox_2)
        self.bEliminarBD.setGeometry(QtCore.QRect(10, 180, 149, 51))
        self.bEliminarBD.setStyleSheet("background-color: qlineargradient(spread:pad, x1:1, y1:0, x2:0, y2:1, stop:0 rgba(255, 100,100, 255), stop:1 rgba(255, 255, 255, 255));")
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/icons/recursos/Remove_from_database_Icon_256.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bEliminarBD.setIcon(icon5)
        self.bEliminarBD.setIconSize(QtCore.QSize(40, 40))
        self.bEliminarBD.setObjectName("bEliminarBD")
        self.groupBox_3 = QtWidgets.QGroupBox(self.add)
        self.groupBox_3.setGeometry(QtCore.QRect(470, 70, 151, 91))
        self.groupBox_3.setObjectName("groupBox_3")
        self.bImportarXls = QtWidgets.QPushButton(self.groupBox_3)
        self.bImportarXls.setGeometry(QtCore.QRect(10, 30, 131, 51))
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/recursos/xls.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bImportarXls.setIcon(icon6)
        self.bImportarXls.setIconSize(QtCore.QSize(40, 40))
        self.bImportarXls.setObjectName("bImportarXls")
        self.groupBox_4 = QtWidgets.QGroupBox(self.add)
        self.groupBox_4.setGeometry(QtCore.QRect(470, 220, 151, 101))
        self.groupBox_4.setObjectName("groupBox_4")
        self.bInformePdf = QtWidgets.QPushButton(self.groupBox_4)
        self.bInformePdf.setGeometry(QtCore.QRect(10, 30, 131, 51))
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/icons/recursos/pdf.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bInformePdf.setIcon(icon7)
        self.bInformePdf.setIconSize(QtCore.QSize(40, 40))
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/icons/recursos/add-user.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bAddPropietario.setIcon(icon8)
        self.bAddPropietario.setIconSize(QtCore.QSize(30, 30))
        ...
        self.bAddJuego.setGeometry(QtCore.QRect(10, 180, 161, 61))
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/recursos/plus.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bAddJuego.setIcon(icon9)
        self.bAddJuego.setIconSize(QtCore.QSize(40, 40))
        ...
        self.bSalir.setGeometry(QtCore.QRect(790, 600, 71, 21))
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/icons/recursos/salida.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bSalir.setIcon(icon10)
        self.bSalir.setIconSize(QtCore.QSize(16, 16))
        self.bSalir.setObjectName("bSalir")
        self.lbStatus = QtWidgets.QLabel(self.centralwidget)
        self.lbStatus.setGeometry(QtCore.QRect(20, 600, 731, 21))
        ...
        self.actionAddJuego = QtWidgets.QAction(MainWindow)
        self.actionAddJuego.setObjectName("actionAddJuego")
        ...
        self.menuArchivo.addAction(self.actionAddJuego)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.groupBox_2.setTitle(_translate("MainWindow", "Gestión de BD"))
        self.bImportarBD.setText(_translate("MainWindow", "Importar BD"))
        self.bExportarBD.setText(_translate("MainWindow", "Exportar BD"))
        self.bEliminarBD.setText(_translate("MainWindow", "Eliminar BD"))
        self.groupBox_3.setTitle(_translate("MainWindow", "Importar datos"))
        ...
        self.menuBase_de_Datos.setTitle(_translate("MainWindow", "Gestión de BD"))
        self.menuXLS.setTitle(_translate("MainWindow", "XLS"))
        self.menuInformes.setTitle(_translate("MainWindow", "Informes"))
        self.toolBar.setWindowTitle(_translate("MainWindow", "toolBar"))
        self.actionAddJuego.setText(_translate("MainWindow", "Añadir Juego"))
        self.actionAddJuego.setShortcut(_translate("MainWindow", "Ctrl+Shift+N"))
