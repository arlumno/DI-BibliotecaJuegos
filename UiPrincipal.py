...
"*/")
        ...
        self.bAddJuego.setGeometry(QtCore.QRect(220, 170, 131, 41))
        self.bAddJuego.setObjectName("bAddJuego")
        self.bAddGame_2 = QtWidgets.QPushButton(self.add)
        self.bAddGame_2.setGeometry(QtCore.QRect(40, 160, 121, 41))
        self.bAddGame_2.setObjectName("bAddGame_2")
        self.lwPropietarios = QtWidgets.QListWidget(self.add)
        self.lwPropietarios.setGeometry(QtCore.QRect(40, 210, 121, 271))
        self.lwPropietarios.setObjectName("lwPropietarios")
        self.bImportarXls = QtWidgets.QPushButton(self.add)
        self.bImportarXls.setGeometry(QtCore.QRect(220, 220, 131, 41))
        self.bImportarXls.setObjectName("bImportarXls")
        self.bExportarXls = QtWidgets.QPushButton(self.add)
        self.bExportarXls.setGeometry(QtCore.QRect(220, 270, 131, 41))
        self.bExportarXls.setObjectName("bExportarXls")
        self.bInformePdf = QtWidgets.QPushButton(self.add)
        self.bInformePdf.setGeometry(QtCore.QRect(220, 350, 131, 41))
