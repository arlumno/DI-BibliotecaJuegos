...
"*/")
        ...
        self.horizontalLayoutWidget_2.setGeometry(QtCore.QRect(10, 17, 661, 45))
        ...
        self.bReiniciarFiltros.setGeometry(QtCore.QRect(760, 17, 75, 46))
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/icons/recursos/borrar.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bReiniciarFiltros.setIcon(icon)
        self.bReiniciarFiltros.setIconSize(QtCore.QSize(20, 20))
        self.bReiniciarFiltros.setObjectName("bReiniciarFiltros")
        self.bFiltrar = QtWidgets.QPushButton(self.groupBox)
        self.bFiltrar.setGeometry(QtCore.QRect(680, 17, 75, 46))
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap(":/icons/recursos/filter.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.bFiltrar.setIcon(icon1)
        self.bFiltrar.setIconSize(QtCore.QSize(20, 20))
        ...
        self.label_8.setGeometry(QtCore.QRect(0, 0, 871, 31))
        font = QtGui.QFont()
        font.setFamily("MS Gothic")
        font.setPointSize(16)
        font.setBold(False)
